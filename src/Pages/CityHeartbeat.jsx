        ...
        <div className="container mx-auto px-6 pt-6 pb-24 grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-gray-900 bg-opacity-70 backdrop-blur-md rounded-2xl p-6 border border-blue-500 border-opacity-20 shadow-2xl">
              ...
              <div className="bg-gray-800 bg-opacity-50 rounded-xl h-64 flex items-center justify-center relative overflow-hidden">
                ...
                {hazards.map((hazard, i) => (
                  <div key={hazard.id} 
                    className={`absolute w-8 h-8 rounded-full bg-${hazard.color}-500 flex items-center justify-center cursor-pointer transform hover:scale-125 transition-transform`}
                    style={{
                      left: `${20 + i * 25}%`,
                      top: `${30 + i * 10}%`,
                      boxShadow: `0 0 15px ${hazard.color === 'red' ? '#f56565' : hazard.color === 'blue' ? '#4299e1' : '#ecc94b'}`
                    }}
                ...
                {hazards.map(hazard => (
                  ...
                  >
                    <div className="flex items-start">
                      <div className={`w-3 h-3 rounded-full bg-${hazard.color}-500 mt-1.5 mr-3`}></div>
                      <div className="flex-1">
                        ...
                        <div className="flex justify-between items-center mt-2">
                          ...
                          <span className={`text-${hazard.color}-400 font-bold`}>
      ...
      {activeHazard && (
        <div className="fixed z-30 bg-gray-900 bg-opacity-90 backdrop-blur-md rounded-2xl p-4 w-64 border border-blue-500 border-opacity-30 shadow-2xl transition-all"
          ...
          <div className="flex items-center mt-2">
            ...
            <span className={`text-${hazards.find(h => h.id === activeHazard).color}-400`}>{hazards.find(h => h.id === activeHazard).severity}</span>
          </div>
...
export default CityHeartbeatDashboard;